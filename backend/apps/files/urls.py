"""
apps/files/urls.py  — UPDATED with folder endpoints
────────────────────────────────────────────────────────────────────────────
Add the lines marked NEW to your existing urls.py.
The existing routes are listed here unchanged so you can copy the whole file.
"""
